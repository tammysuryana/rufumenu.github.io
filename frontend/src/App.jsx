...
function App() {
    ...
    const readData = ()=>{
        fetch('http://127.0.0.1:1337/menu-items', {
            method : "GET",
            mode : 'cors',
            headers : {
...
<<<<<<< HEAD
                {menu.map((e)=>{
                    return <Service_card image={e.menu_items_photo[0].url} name={e.menu_items_nama} price={e.menu_items_price} />
                })}

               {/* {menu.map((e)=>{
                   console.log(e.menu_items_photo[0].url);
...
>>>>>>> e5930f4dfe7ceca7907e9d7342eb0e7fac891992
            </div>
        </div>
</section>
...
<section className="mid-sec py-5" id="menu">
        <div className="container-fluid py-lg-5">
            <div className="header pb-lg-3 pb-3 text-center">
                <h3 className="tittle mb-lg-3 mb-3">Bigger & Bolder</h3>
            </div>
            <div className="middile-inner-con">
                <div className="tab-main mx-auto text-center">

                    <input id="tab1" type="radio" name="tabs" checked/>
                    <label for="tab1"><span className="fa fa-align-center" aria-hidden="true"></span> Burgers</label>

                    <input id="tab2" type="radio" name="tabs"/>
                    <label for="tab2"><span className="fa fa-bolt" aria-hidden="true"></span> Fries</label>

                    <input id="tab3" type="radio" name="tabs"/>
                    <label for="tab3"><span className="fa fa-bitbucket" aria-hidden="true"></span> Drinks</label>
   ...
   <section className="gallery py-5" id="gallery">
        <div className="container py-md-5">
            <div className="header text-center">
                <h3 className="tittle mb-lg-5 mb-3">Our Gallery</h3>
            </div>
